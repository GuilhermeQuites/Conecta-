...
if (!empty($_GET['url'])) {
    ...
    switch ($url[0]) {
        ...
        case 'entradas':
            include('form_entradas.php');
            break;

        case 'listar':
            include('listar_leads.php');
            break;
        ...
        case 'regioes_filtrar':
            include('regioes_filtrar.php');
            break;

        case 'deleta_lead':
            $id = $url[1];
            include('deleta_lead.php');
            break;

        case 'deleta_contato':
            $id = $url[1];
            include('deleta_contato.php');
            break;
