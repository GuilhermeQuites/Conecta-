<div class="container-fluid">
    <div class="card card-horizontal card-default card-md mb-4" style="background-color: #3D3D3B;">
        <h1 class="text-center my-5">Listar Leads</h1>
...
<?php
    include_once "./bd/conexao.php";
              ...
              // Selecionando todos os leads do banco de dados
              if(isset($_POST['nome'])){
                $nome = $_POST['nome'];
                $sql = "SELECT id_lead, nome_lead, entrada_lead, telefone_lead, email_lead, estado_lead, cidade_lead, descricao_lead, data_lead, melhor_horario_lead, classificacao_lead, artista_lead, nome_casa_noturna, valor_lead, data_show, status_lead, mesorregiao_lead, regiao_lead  FROM leads WHERE nome_lead = '$nome'";
                        ...
                        '<td>
                            <ul style="display: flex; flex-direction: row;">
                                <li style="padding: 2px;">
                                    <a class="edit" href="comentario/'.$row['id_lead'] . '">
                                ...
                                <li style="padding: 2px;">
                                    <a id="confirm-delete"  href="listar/'.$row['id_lead'] . ' "class="remove">
                                        <i class="uil uil-trash-alt" data-bs-toggle="modal" data-bs-target="#modal-exclusao"></i>
                                    </a>
                                </li>
                            </ul>
                        </td>';
...
?>
<div class="modal fade show" id="modal-exclusao" tabindex="-1" role="dialog" aria-hidden="true">
       ...
       <div class="modal-content ">
          <div class="modal-body">
             ...
             <div class="admin__button-group button-group d-flex pt-1 justify-content-md-end justify-content-end mt-10 mb-10" style="margin-right: 10px;">
                <a href="deleta_lead/<?php echo $id; ?>">
...
<?php
$categorias = $conn->query($insert = "SELECT * FROM categoria_entradas");
$artistas = $conn->query($select = "SELECT * FROM artista");
$artistas_duplicar = $conn->query($select = "SELECT * FROM artista");
if(isset($_POST["nome"])){
    $nome = $_POST["nome"];
    $lead = $conn->query($select = "SELECT * FROM leads WHERE id_lead = '$id'");
    $dados = $lead->fetch_array();
}
?>
...
<div class="modal fade show" id="modal-edicao" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-info  modal-lg" role="document">
        <div class="modal-content ">
            <div class="modal-body">
                <div class="modal-info-body d-flex">
                    ...
                    <div class="modal-info-text">
                        <h6>Para editar um Lead modifique os dados abaixo!</h6>
                    </div> 
                </div>
                <BR>
                <form id="verificar" method="post">
                 <div class="row" id = "dvConteudo"> 
                    <div class="col-6">
                        <label> Nome </label> 
                        <input type="text" required class="form-control" name="nome" id="nome" value="<?php echo $dados['nome_lead'] ?>">
                    </div>
                    <div class="col-6">
                        <label> Entrada </label> 
                        <select type="text" name="entrada" class="form-control" placeholder="Entrada" required>
                            <option value="<?php echo $dados['entrada_lead'] ?>"><?php echo $dados['entrada_lead'] ?></option>
                            <?php
                    ...
                    <div class="col-6">
                        <label> Artista </label> 
                        <select type="text" name="artista" class="form-control" placeholder="Artista" required>
                            <option value="<?php echo $dados['artista_lead'] ?>"><?php echo $dados['artista_lead'] ?></option>
                            <?php
            ...
            <div class="col-6">
            <label> Nome casa noturna </label> 
                <input type="text" required class="form-control" name="nome_casa_noturna" id="nome_casa_noturna" value="<?php echo $dados['nome_casa_noturna'] ?>">
            </div> 

            <div class="col-6">
            <label> Telefone </label> 
                <input type="text" required class="form-control" name="telefone" id="telefone" value="<?php echo $dados['telefone_lead'] ?>">
            </div> 
            
            <div class="col-6">
            <label> Email </label> 
                <input type="text" required class="form-control" name="email" id="email" value="<?php echo $dados['email_lead'] ?>">
            </div>

            <div class="col-6">
                <label> Estado </label> 
                <select type="text" name="estado" class="form-control" placeholder="Estado" onchange="buscaCidades(this.value)" required>
                    <option value="<?php echo $dados['estado_lead'] ?>"><?php echo $dados['estado_lead'] ?></option>
            ...
            <div class="col-6">
                <label> Cidade </label> 
                <select type="text" id="cidade" name="cidade" class="form-control" placeholder="Cidade" required>
                    <option value="<?php echo $dados['cidade_lead'] ?>"><?php echo $dados['cidade_lead'] ?></option>
                </select>
            </div>
            <div class="col-6">
                <label> Data </label> 
                <input type="date" required class="form-control" name="data" id="descricao" value="<?php echo $dados['data_lead'] ?>">
            </div>
            <div class="col-6">
                <label> Horário </label> 
                <select type="text" name="horario" class="form-control ih-medium radius-xs" placeholder="Horário" required>
                    <option value="<?php echo $dados['melhor_horario_lead'] ?>"><?php echo $dados['melhor_horario_lead'] ?></option>
            ...
            <div class="col-6">
                ...
                <select type="text" name="classificacao" class="form-control ih-medium radius-xs" placeholder="Classificação" required>
                    <option value="<?php echo $dados['classificacao_lead'] ?>"><?php echo $dados['classificacao_lead'] ?></option>
            ...
            <div class="col-6">
            <label>Valor</label> 
                <input type="text" required class="form-control" name="valor_lead" id="valor_lead" value="<?php echo $dados['valor_lead'] ?>">
            </div> 

            <div class="col-6">
            <label>Data Show</label> 
                <input type="date" required class="form-control" name="data_show" id="data_show" value="<?php echo $dados['data_show'] ?>">
            </div>       
            
            <div class="col-6">
              <label for="status_lead">Status</label>
              <select class="form-control" id="status_lead" name="status_lead" required>
                <option value="<?php echo $dados['status_lead'] ?>"><?php echo ucfirst($dados['status_lead']) ?></option>
            ...
            <div class="col-6">
                ...
                <textarea type="text" required class="form-control" name="descricao" id="descricao"><?php echo $dados['descricao_lead'] ?></textarea>
            </div> 
...
<?php
    if (isset($_POST['atualizado'])) {
        ...
        $nome_lead = $_POST["nome"];
        $entrada_lead = $_POST["entrada"];
        $telefone_lead = $_POST["telefone"];
        $email_lead = $_POST["email"];
        $estado_lead = $_POST["estado"];
        $cidade_lead = $_POST["cidade"];
        $data_lead = $_POST["data"];
        $melhor_horario_lead = $_POST["horario"];
        $classificacao_lead = $_POST["classificacao"];
        $descricao_lead = $_POST["descricao"];
        $artista_lead = $_POST['artista'];
        $nome_casa_noturna = $_POST['nome_casa_noturna'];
        $sql = "UPDATE leads SET nome_lead='$nome_lead', entrada_lead='$entrada_lead', telefone_lead='$telefone_lead', email_lead='$email_lead', estado_lead='$estado_lead', cidade_lead='$cidade_lead', descricao_lead='$descricao_lead', data_lead='$data_lead', melhor_horario_lead='$melhor_horario_lead', classificacao_lead='$classificacao_lead', artista_lead='$artista_lead', nome_casa_noturna='$nome_casa_noturna' WHERE id_lead=$id_lead";
