...
<div class="col-lg-12">
    <div class="card card-Vertical card-default card-md mb-4" style="background-color: #3D3D3B">
        <h1 class=" text-center my-5">Cadastrar Eventos</h1>
            ...
            <div class="horizontal-form">
                <form action="" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-25">
                            <label class=" col-form-label color-dark fs-14 fw-500 align-center mb-20">Evento Anual</label>
                            <select type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="evento_anual" style="background-color: #51514F" required>
                                <option value=""></option>
...
if (isset($_POST['submit']))
    $conn->query($insert = "INSERT INTO eventos (nome_evento , cidade_evento, estado_evento, evento_anual) VALUES ('$_POST[nome]', '$_POST[cidade]', '$_POST[estado]', '$_POST[evento_anual]')");
?>
