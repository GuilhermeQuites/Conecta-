...
<body>
   <main class="main-content" style="background-color:gray">
      ...
      <div class="admin" style="background-color:gray">
               ...
               <div class="col-xxl-3 col-xl-4 col-md-6 col-sm-8">
                  <div class="edit-profile">
                     <div class="edit-profile__logos">
                        <a href="index.html">
                           <img class="dark" src="img/Logo Conecta.png" alt="" style="margin-top: -120px;margin-bottom: -60px; width: 300px">
                        </a>
                     </div>
                     <div class="card border-0" style="background-color: #3D3D3B">
                        <div class="card-header" style="background-color: #3D3D3B">
                           <div class="edit-profile__title">
                              <h6 style="color:white">Acessar</h6>
                           </div> 
                        ...
                        <div class="card-body">
                           <div class="">
                              ...
                              <label for="username" style="color: white">Usuário:</label>
                                 <input type="text" class="form-control" name="usuario" id="login" style="background-color: gray">
                              </div>
                                <div class="form-group mb-15">
                                 <label for="password-field" style="color: white">Senha:</label>
                                 <div class="position-relative">
                                    <input id="password-field" type="password" class="form-control"  name="senha" style="background-color: gray">
                              ...
                              <div class="admin-condition">
                                 <div class="checkbox-theme-default custom-checkbox ">
                                    ...
                                    <label for="check-1" >
                                       <span class="checkbox-text" style="color: white">Lembrar meus dados</span>
                                    </label>
                                 </div>
                                 <a href="forget-password.html"><Esqueceu style="color: #0D811D">Esqueceu a senha?</span></a>
                              </div>
