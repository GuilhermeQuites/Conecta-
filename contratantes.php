            ...
            <div class="horizontal-form">
                <form action="" method="post">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-25">
                            <label class=" col-form-label color-dark fs-14 fw-500 align-center mb-20">Email</label>
...
if (isset($_POST['submit']))
    $conn->query($insert = "INSERT INTO contratantes (nome_contratante, email_contratante, telefone_contratante, estado_contratante, cidade_contratante, artista_contratante) VALUES ('$_POST[nome]', '$_POST[email]', '$_POST[telefone]', '$_POST[estado]', '$_POST[cidade]', '$_POST[artista]')");
?>
